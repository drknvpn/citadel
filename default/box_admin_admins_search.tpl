	  	...
	  	<tr>
	  		...
	  		<div class="panel">
				...
				<tr>
			        ...
			        <td class="listtable_1" width="26%">Эл. почта</td>
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >Веб-группа</td>
			        <td class="listtable_1" >
				...
				<tr>
			        ...
			        <td class="listtable_1" >Группа Админа сервера</td>
			        <td class="listtable_1" >
				...
				<tr>
			        ...
			        <td class="listtable_1" >Группа сервера</td>
			        <td class="listtable_1" >
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >Веб-разрешения</td>
			        <td class="listtable_1" >
				...
				<tr>
			        ...
			        <td class="listtable_1" >Разрешения сервера</td>
			        <td class="listtable_1" >
			    ...
			    <tr colspan="3">
			        <td colspan="3">{sb_button text="Поиск" onclick="search_admins();" class="ok" id="searchbtn" submit=false}</td>
			    </tr>
			   </table>
			   </div>
		  </td>
