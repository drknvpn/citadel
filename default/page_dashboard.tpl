...
<div class="front-module" style="width:100%">
	<table width="100%" cellpadding="1" class="listtable">
		...
		<tr height="16">
			...
			<td class="listtable_top"><strong>Имя</strong></td>
			<td width="14%" class="listtable_top"><strong>Срок</strong></td>
		</tr>
      ...
      <td class="listtable_1" align="center"><img src="images/games/{$player.icon}" width="16" alt="MOD" title="МОД" /></td>
      <td class="listtable_1" align="center">{$player.created}</td>
      <td class="listtable_1">
        {if empty($player.short_name)}
          <i><font color="#677882">Не найден ник</font></i>
        {else}
...
<div class="front-module" style="float:right;width:49%">
	<table width="100%" cellpadding="1" class="listtable">
		<tr>
			<td colspan="3">
				<table width="100%" cellpadding="0" cellspacing="0" class="front-module-header">
					<tr>
						<td align="left">
							Последние заблокированные игроки
						</td>
						<td align="right">
							Всего заблокированно: {$total_blocked}
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td height="16" class="listtable_top"><b>Имя</b></td>	  
		</tr>
		{foreach from=$players_blocked item=player}
		<tr{if $dashboard_lognopopup} onclick="{$player.link_url}"{else} onclick="{$player.popup}"{/if} onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'" style="cursor: pointer;" id="{$player.server}" title="Запрос данных сервера...">
...
<div class="front-module" style="float:left;width:49%">
	<table width="100%" cellpadding="1" class="listtable">
		...
		<tr height="16">
			...
			<td width="24%" class="listtable_top" align="center"><strong>Дата/Время</strong></td>
			<td class="listtable_top"><strong>Имя</strong></td>
			<td width="23%" class="listtable_top"><strong>Срок</strong></td>
		</tr>
		{foreach from=$players_commed item=player}
		<tr onclick="{$player.link_url}" onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'" style="cursor:pointer;" height="16">
      <td class="listtable_1" align="center"><img src="{$player.type}" width="16" alt="MOD" title="МОД" /></td>
