...
<table width="90%" align="center" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
  <tr>
	<td valign="top"><div class="rowdesc">{help_icon title="Текст комментария" message="Введите текст, который вы хотите сказать."}Комментарий</div></td>
  </tr>
  <tr>
	<td><div align="left">
  ...
  <tr>
	<td colspan='3'>
		<span style='font-size:6pt;color:grey;'>последнее редактирование в {$com.edittime} от {$com.editname}</span>
	</td>
  </tr>
  {/if}
  {/foreach}
...
{else}
<h3 align="left">Обзор списка банов - <i>Всего банов: {$total_bans}</i></h3>
<br />
{php} require (TEMPLATES_PATH . "/admin.bans.search.php");{/php}
<br />
<div id="banlist-nav"><a href="index.php?p=banlist&hideinactive={if $hidetext == 'Скрыть'}true{else}false{/if}{$searchlink|htmlspecialchars}" title="{$hidetext} inactive">{$hidetext} неактивные</a> | <i>Всего банов: {$total_bans}</i></div>
<div id="banlist">
	<table width="100%" cellspacing="0" cellpadding="0" align="center" class="listtable">
        ...
        <td height="16" class="listtable_1">
          ...
          {if empty($ban.player)}
            <i><font color="#677882">нет ника</font></i>
          {else}
		  ...
		  <img src="images/demo.png" alt="Demo" title="Демо в наличии" style="height:14px;width:14px;" />
		  </div>
		  {/if}
		  {if $view_comments && $ban.commentdata != "Нету" && $ban.commentdata|@count > 0}
		  <div style="float:right;">
		  {$ban.commentdata|@count} <img src="images/details.png" alt="Comments" title="Комментарии" style="height:12px;width:12px;" />
		  </div>
		  {/if}
        </td>
		{if !$hideadminname}
        ...
        <td colspan="7" align="center">
          <div class="opener">
              ...
              <tr align="left">
                <td width="30%" height="16" class="listtable_1">Игрок</td>
                <td height="16" class="listtable_1">
                  {if empty($ban.player)}
                    <i><font color="#677882">нет ника</font></i>
                  {else}
              ...
              <tr align="left">
                ...
                <td height="16" class="listtable_1">
                  {if empty($ban.steamid)}
                    <i><font color="#677882">Нет Steam ID</font></i>
                  {else}
                    {$ban.steamid}
                  {/if}
                </td>
              ...
              <tr align="left">
                ...
                <td height="16" class="listtable_1">
                  {if empty($ban.steamid)}
                    <i><font color="#677882">Нет Steam3 ID</font></i>
                  {else}
              ...
              {if $ban.type == 0}
              <tr align="left">
                <td width="20%" height="16" class="listtable_1">Steam64 (Community) ID</td>
              ...
              <tr align="left">
                ...
                <td height="16" class="listtable_1">
                  {if $ban.ip == "none"}
                    <i><font color="#677882">IP-адрес не найден</font></i>
                  {else}
                    {$ban.ip}
                  {/if}
                </td>
              ...
              <tr align="left">
							...
							<tr align="left">
					            ...
					            <td height="16" class="listtable_1">
								{if $ban.ureason == ""}
									<i><font color="#677882">нет причин</font></i>
								{else}
									{$ban.ureason}
								{/if}
								</td>
							 ...
							 <tr align="left">
					            <td width="20%" height="16" class="listtable_1">азбанен Админом</td>
					            <td height="16" class="listtable_1">
							...
							{/if}
					        <tr align="left">
					            <td width="20%" height="16" class="listtable_1">Заканчивается</td>
					            <td height="16" class="listtable_1">
							...
							{/if}
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Забанен на</td>
							...
							<tr align="left">
								...
								<td height="16" class="listtable_1">
								{if $ban.banlog == ""}
									<i><font color="#677882">нету</font></i>
								{else}
									{$ban.banlog}
								{/if}
								</td>
								...
								<table width="100%" border="0">
									{foreach from=$ban.commentdata item=commenta}
									 ...
									 {/if}
									  ...
									  <tr>
										<td colspan='3'>
											<span style="font-size:6pt;color:grey;">последнее редактирование {$commenta.edittime} by {if !empty($commenta.editname)}{$commenta.editname}{else}<i><font color="#677882">Администратор удален</font></i>{/if}</span>
										</td>
									  </tr>
									  {/if}
									  {/foreach}
	...
	&nbsp;&nbsp;L&nbsp;&nbsp;<a href="#" onclick="TickSelectAll();return false;" title="Выбрать все" name="tickswitchlink" id="tickswitchlink">Выбрать всё</a>&nbsp;&nbsp;|&nbsp;
	...
	{/if}
	{if $can_export }
		<a href="./exportbans.php?type=steam" title="Export Permanent SteamID Bans">Экспорт Постоянных Банов по SteamID</a>&nbsp;&nbsp;|&nbsp;
		<a href="./exportbans.php?type=ip" title="Export Permanent IP Bans">Экспорт Постоянных Банов по IP</a>
	{/if}
</div>
{literal}
