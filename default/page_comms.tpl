...
<table width="90%" align="center" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
  ...
  <tr>
	<td colspan='3'>
		<span style='font-size:6pt;color:grey;'>последнее редактирование {$com.edittime} от {$com.editname}</span>
	</td>
  </tr>
  {/if}
  {/foreach}
...
{else}
<h3 align="left">Обзор списка блокировок - <i>Всего блоков: {$total_bans}</i></h3>
<br />
...
<a href="index.php?p=commslist&hideinactive={if $hidetext == 'Скрыть'}true{else}false{/if}{$searchlink|htmlspecialchars}" title="{$hidetext} inactive">{$hidetext} неактивные</a>
<div id="banlist">
	<table width="100%" cellspacing="0" cellpadding="0" align="center" class="listtable">
		<tr>
			...
			{if !$hideadminname}
			<td width="12%" height="16" class="listtable_top"><b>Админ</b></td>
			{/if}
			<td width="16%" height="16" class="listtable_top" align="center"><b>Срок</b></td>
		</tr>
        ...
        <td height="16" class="listtable_1">
		  ...
		  {$ban.commentdata|@count}&thinsp;<img src="images/details.png" alt="Comments" title="Комментарии" style="height:12px;width:12px;" />
		  {/if}
		  {if $view_bans}
		  {$ban.counts}
		  {/if}
        ...
        <td colspan="7" align="center">
          <div class="opener">
              ...
              <tr align="left">
                ...
                <tr align="left">
								<td width="20%" height="16" class="listtable_1">Поставлен</td>
								<td height="16" class="listtable_1">{$ban.ban_date}</td>
					        </tr>
					        <tr align="left">
					            <td width="20%" height="16" class="listtable_1">Срок мута</td>
					            <td height="16" class="listtable_1">{$ban.banlength}</td>
					        </tr>
							{if $ban.unbanned}
							<tr align="left">
					            <td width="20%" height="16" class="listtable_1">Причина снятия</td>
					            <td height="16" class="listtable_1">
								{if $ban.ureason == ""}
									<i><font color="#677882">нет причины</font></i>
								{else}
									{$ban.ureason}
								{/if}
								</td>
							 ...
							 <tr align="left">
					            <td width="20%" height="16" class="listtable_1">Разблокировано администратором</td>
					            <td height="16" class="listtable_1">
							...
							{if !$hideadminname}
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Заблокировано администратором</td>
								<td height="16" class="listtable_1">
									{if !empty($ban.admin)}
										{$ban.admin|escape:'html'}
									{else}
							...
							{/if}
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Замучен на</td>
							...
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Всего блоков</td>
          	...
          	<!-- ###############[ End Sliding Panel ]################## -->
		{/foreach}
	</table><div align="right" style="margin-top: 3px; font-size:7pt">SourceComms плагин &#038;	и интеграция с SourceBans создана <a href="https://github.com/ppalex7" target="_blank">Alex</a></div>
</div>
{literal}
