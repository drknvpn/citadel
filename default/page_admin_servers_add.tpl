	...
	<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
		<tr>
		    <td valign="top" width="35%">
		    	<div class="rowdesc">{help_icon title="Адрес сервера" message="Это IP-адрес вашего сервера. Вы также можете ввести домен, если у вас есть эта настройка."}IP-адрес/Домен сервера</div>
		    </td>
		    <td>
		    	<div align="left">
		...
		<tr>
			<td valign="middle">
				<div class="rowdesc">{help_icon title="RCON пароль" message="Это ваш пароль RCON-сервера. Это можно найти в файле server.cfg рядом с <i>rcon_password</i>.<br /><br />Это будет использоваться, чтобы позволить администраторам управлять сервером через веб-интерфейс."}RCON пароль</div>
			</td>
		    <td>
		    	<div align="left">
