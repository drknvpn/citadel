...
<div id="submit-main">
	Здесь вы сможете подать жалобу на игрока, нарушающего правила игрового сервера. При подаче жалобы мы просим вас заполнить все поля как можно более подробно в ваших комментариях. Это гарантирует, что ваша жалоба будет обработана намного быстрее.<br /><br />
...
<tr>
	<td width="20%" valign="top">
		...
		(Пожалуйста, напишите подробный комментарий. А не коротко: «Читер»)	</td>
