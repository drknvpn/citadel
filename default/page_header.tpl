            ...
            <div id="tabs">
	            {if $logged_in}
	                <div style="float: right;">
	         	        <ul>
	         	        	<li>
	         	        		<a style="background-color: #B8383B;" href='index.php?p=logout'>Выйти</a>
	         	        	</li>
	         	        </ul>
	         	    </div>
	         	    <div class="user">Привет, <a href='index.php?p=account'>{$username}</a></div>
	                {else}
	                <div style="float: right;">
	                    <ul>
	                    	<li>
	          	                <a style="background-color: #70B04A;" href='index.php?p=login'>Войти</a>
	          	            </li>
	          	        </ul>
	          	    </div>
	            {/if}
