...
{else}
	<div id="protests">
		<h3 style="margin-top:0px;">Архив Протестов бана (<span id="protcountarchiv">{$protest_count_archiv}</span>)</h3>
		Нажмите на ник игрока, чтобы просмотреть информацию об их бане<br /><br />
        <div id="banlist-nav"> 
        {$aprotest_nav}
        </div>
		<table width="100%" cellpadding="0" cellspacing="0">
          ...
          <td class="toggler" style="border-bottom: solid 1px #ccc" height='16'>{if $protest.archiv!=2}<a href="./index.php?p=banlist{if $protest.authid!=""}&advSearch={$protest.authid}&advType=steamid{else}&advSearch={$protest.ip}&advType=ip{/if}" title="Показать бан">{$protest.name}</a>{else}<i><font color="#677882">Бан удален</font></i>{/if}</td>
          ...
          {/if}
          <a href="index.php?p=admin&c=bans&o=email&type=p&id={$protest.pid}">Отпр. Сообщение</a>
          </td>
				</tr>
							...
							<table width="90%" cellspacing="0" cellpadding="0" class="listtable">
								...
								<tr align="left">
									<td height="16" align="left" class="listtable_1" colspan="2">
										<b>Архивировано, потому что {$protest.archive}</b>
									</td>
								...
								{/if}
                                <tr align="left">
                                    <td width="20%" height="16" class="listtable_1">Архивировано</td>
								...
								<tr align="left">
            						<td width="20%" height="16" class="listtable_1">IP Протестующего</td>
            						<td height="16" class="listtable_1">{$protest.pip}</td>
            					</tr>
								<tr align="left">
            						<td width="20%" height="16" class="listtable_1">Протест от</td>
            						<td height="16" class="listtable_1">{$protest.datesubmitted}</td>
            					</tr>
          						<tr align="left">
            						<td width="20%" height="16" class="listtable_1">Сообщение протеста</td>
