{if NOT $permission_listmods}
	Доступ закрыт!
{else}
	<h3>Мод сервера ({$mod_count})</h3>
	<table width="100%" cellspacing="0" cellpadding="0" align="center" class="listtable">
		<tr>
			<td width="50%" height='16' class="listtable_top"><strong>Имя</strong></td>
			<td width="25%" height='16' class="listtable_top"><strong>Папка Мода</strong></td>
			<td width="10%" height='16' class="listtable_top"><strong>Значок Мода</strong></td>
