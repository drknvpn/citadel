<h3 align="left">Темы</h3>
<div id="current-theme-holder">
	<h4 class="largetitle">Выбранная тема: <span id="theme.name">{$theme_name}</span></h4>
...
<br />
<h4 class="largetitle">Доступные темы</h4>
Нажмите ниже на тему, чтобы просмотреть подробную информацию о ней.<br /><br />
<div id="theme-list">
	<ul>
