							...
							<tr align="left">
									...
									<table width="100%" border="0">
										{foreach from=$sub.commentdata item=commenta}
                                            ...
                                            <tr>
                                            <td colspan="3">
                                              <span style="font-size:6pt;color:grey;">последнее редактирование {$commenta.edittime} от {if !empty($commenta.editname)}{$commenta.editname}{else}<i><font color="#677882">Администратор удален</font></i>{/if}</span>
                                            </td>
                                            </tr>
                                            {/if}
                                          {/foreach}
