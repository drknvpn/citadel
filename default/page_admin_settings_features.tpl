<form action="" method="post">
    ...
    <table width="99%" border="0" style="border-collapse:collapse;" id="group.features" cellpadding="3">
        ...
        <tr>
            <td valign="top" width="35%"><div class="rowdesc">{help_icon title="Включить публичные баны" message="Установите этот флажок, чтобы включить общий список банов для публичной загрузки и совместного использования."}Сделать баны на экспорт общедоступными</div></td>
            <td>
                <div align="left">
		...
		<tr>
			<td valign="top"><div class="rowdesc">{help_icon title="Включить групповой бан" message="Установите этот флажок, если вы хотите включить бан целой группы steam."}Включить групповой бан</div></td>
		    <td>
		    	<div align="left">
                    {if $steamapi}
