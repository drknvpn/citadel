<table style="width: 101%; margin: 0 0 -2px -2px;">
	<tr>
		<td colspan="3" class="listtable_top"><b>Пожалуйста, выберите вариант администрирования</b></td>
	</tr>
</table>
<div id="cpanel">
	<ul>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
	<tr>
		...
		<td width="33%" class="listtable_top" align="center" style="border-right: 3px solid #CFCAC6; border-left: 3px solid #CFCAC6;">Информация о администраторах</td>
	...
	<tr>
		...
		<td class="listtable_1" style="border-left: 3px solid #CFCAC6;">Соединений заблокировано: <strong>{$total_blocks}</strong></td>
	</tr>
	<tr>
