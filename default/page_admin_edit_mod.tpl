<form action="" method="post">
	<div id="add-group">
		...
		<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
			...
			<tr>
				<td valign="top"><div class="rowdesc">{help_icon title="Имя папки" message="Введите имя папки мода. Например, папка для Counter-Strike: Source - это 'cstrike'"}Папка мода</div></td>
		    	<td>
		    		<div align="left">
