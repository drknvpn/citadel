...
<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
  ...
  <tr>
   ...
   -{if $srvpwset}-
  <tr>
  <td valign="top"><div class="rowdesc">-{help_icon title="Удалить Пароль Сервера" message="Установите этот флажок, если вы хотите удалить пароль своего сервера"}-Remove Password</div></td>
  <td><div align="left">
...
<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
  <tr>
	  <td valign="top"><div class="rowdesc">-{help_icon title="Текущий адрес Электронной Почты" message="Это ваш текущий сохраненный адрес электронной почты."}-Текущий адрес Электронной Почты</div></td>
