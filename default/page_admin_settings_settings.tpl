<form action="" method="post">
	...
	<table width="99%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
		...
		<tr>
			<td valign="top"><div class="rowdesc">{help_icon title="Минимальная длина пароля" message="Определите наименьшую длину пароля."}Минимальная длина пароля </div></td>
			<td>
				<div align="left">
		...
		<tr>
			<td valign="top"><div class="rowdesc">{help_icon title="Вступление" message="Задайте заголовок для введения в панель мониторинга."}Вступление </div></td>
			<td>
				<div align="left">
		...
		<tr>
			<td valign="top"><div class="rowdesc">{help_icon title="Вводный текст" message="Задайте текст для введения в панель мониторинга."}Вводный текст </div></td>
		...
		<tr>
			<td valign="top"><div class="rowdesc">{help_icon title="Скрыть имя администратора" message="установите этот флажок, если вы хотите скрыть имя администратора в бан-инфо."}Скрыть имя администратора</div></td>
		    <td>
		    	<div align="left">
