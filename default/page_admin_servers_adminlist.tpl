<h3>Админы на этом сервере ({$admin_count})</h3>
<table width="100%" cellpadding="1" cellspacing="1" class="listtable">
<tr >
            <td width="50%" height='16' class="listtable_top"><strong>Имя администратора</strong></td>
            <td width="50%" height='16' class="listtable_top"><strong>SteamID администратора</strong></td>
</tr>
				...
				<table width="80%" cellspacing="0" cellpadding="0" class="listtable">
					<tr>
						<td height="16" align="left" class="listtable_top" colspan="5">
							<b>Подробности админа</b>            
						</td>
					</tr>
					<tr align="left">
						<td width="30%" height="16" class="listtable_1">Имя</td>
