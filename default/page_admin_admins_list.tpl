...
<table width="99%" cellspacing="0" cellpadding="0" align="center">
	...
	{foreach from="$admins" item="admin"}
		<tr onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'" class="tbl_out opener">
			<td class="listtable_1" style="padding:3px;">{$admin.user} (<a href="./index.php?p=banlist&advSearch={$admin.aid}&advType=admin" title="Показать Баны">{$admin.bancount} Банов</a> | <a href="./index.php?p=banlist&advSearch={$admin.aid}&advType=nodemo" title="Показать Баны без демо">{$admin.nodemocount} Б/Д</a>)</td>
