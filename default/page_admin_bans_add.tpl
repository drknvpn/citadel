  ...
  <div id="add-group1">
    ...
    <tr>
      ...
      <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            {help_icon title="Тип бана" message="Выберите, следует забанить Steam ID или IP-адрес."}Тип бана 
          </div>
        </td>
        <td>
          <div align="left">
      ...
      <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            {help_icon title="Продолжительность бана" message="Выберите, насколько вы хотите забанить этого человека."}Продолжительность бана 
          </div>
        </td>
        <td>
          <div align="left">
