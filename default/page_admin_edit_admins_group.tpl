<form action="" method="post">
	...
	<div id="add-group">
		...
		<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
		  <tr>
		    <td valign="middle"><div class="rowdesc">{help_icon title="Веб-группа" message="Выберите группу, в которой вы хотите, чтобы этот администратор отображался для веб-разрешений"}Группа веб-админов</div></td>
		    <td>
		 ...
		 <tr>
		    <td valign="middle"><div class="rowdesc">{help_icon title="Группа серверов" message="Выберите группу, в которой вы хотите, чтобы этот администратор отображался для получения разрешений администратора сервера"}Группа администраторов сервера </div></td>
