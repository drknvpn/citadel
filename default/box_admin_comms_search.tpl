<div align="center">
	<table width="50%" cellpadding="0" class="listtable" cellspacing="0">
		<tr class="sea_open">
			<td width="2%" height="16" class="listtable_top" colspan="3" style="text-align: center;"><b>Расширенный поиск</b> (Нажмите)</td>
	  	</tr>
	  	<tr>
	  		<td>
	  		<div class="panel">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" width="26%">Ник игрока</td>
							...
							<tr>
								<td>
						            <select class="select" id="length_type" onmouseup="$('length_').checked = true" style="width: 60px; margin-right: 12px;">
										<option value="e" title="равный">=</option>
										<option value="h" title="больше">&gt;</option>
										<option value="l" title="меньше">&lt;</option>
										<option value="eh" title="равно или больше">&gt;=</option>
										<option value="el" title="равно или меньше">&lt;=</option>
									</select>
								</td>
								<td>
								...
								<td>
									<select class="select" id="length" onmouseup="$('length_').checked = true" onchange="switch_length(this);" onmouseover="if(this.options[this.selectedIndex].value=='other')$('length').setStyle('width', '210px');if(this.options[this.selectedIndex].value=='other')this.focus();" onblur="if(this.options[this.selectedIndex].value=='other')$('length').setStyle('width', '20px');" style="width: 127%;">
										...
										<option value="other">Другая срок в минутах</option>
									</select>
								</td>
							</tr>
						</table>
				...
				<tr>
			        ...
			        <td class="listtable_1" >
			            <select class="select" id="ban_type" onmouseup="$('ban_type_').checked = true" style="width: 95%;">
					        <option value="1" selected>Микрофон</option>
				...
				{/if}
			    <tr>
					<td colspan="4">{sb_button text="Поиск" onclick="search_blocks();" class="ok searchbtn" id="searchbtn" submit=false}</td>
			    </tr>
			   </table>
			   </div>
		  </td>
