...
{else}
	<h3>Группы</h3>
	Нажмите на группу, чтобы просмотреть ее разрешения. <br /><br />
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td colspan="4">
				<table width="100%" cellpadding="0" cellspacing="0" class="front-module-header" class="listtable">
					<tr>
						<td align="left">Группы веб-администратора</td>
		...
		<tr>
			<td width="40%" height='16' class="listtable_top"><strong>Название группы</strong></td>
		            		...
		            		<td height="16" class="listtable_1">
								...
								{foreach from=$web_admins_list[$smarty.foreach.web_group.index] item="web_admin"}
									<tr>
										...
										<td width="20%" height="16" class="listtable_1"><a href="index.php?p=admin&c=admins&o=editgroup&id={$web_admin.aid}" title="Редактировать группы">Редактировать</a></td>
	...
	<tr>
		<td colspan="4">
			<table width="100%" cellpadding="0" cellspacing="0" class="front-module-header" class="listtable">
				<tr>
					<td align="left">Группы администрирования сервера</td>
      			...
      			<div class="opener"> 
					<table width="80%" cellspacing="0" cellpadding="0" class="listtable">
						...
						<tr align="left">
		            		...
		            		<td height="16" class="listtable_1">
								...
								{foreach from=$server_admins_list[$smarty.foreach.server_admin_group.index] item="server_admin"}
									<tr>
										...
										{if $permission_editadmin}
										<td width="20%" height="16" class="listtable_1"><a href="index.php?p=admin&c=admins&o=editgroup&id={$server_admin.aid}" title="Редактировать группы">Редактировать</a></td>
							...
							<tr align="left">
		            <td width="20%" height="16" class="listtable_1">Переопределение</td>
		            <td height="16" class="listtable_1">
									<table width="100%" cellspacing="0" cellpadding="0" class="listtable">
										<tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td width="37%" height='16' class="listtable_top"><strong>Название группы</strong></td>
			<td width="25%" height='16' class="listtable_top"><strong>Серверы в группе</strong></td>
			<td width="30%" height='16' class="listtable_top"><strong>Действия</strong></td>
		</tr>
			...
			<tr>	 
	    		<td colspan="7" align="center">     	
	      			<div class="opener"> 
						<table width="80%" cellspacing="0" cellpadding="0" class="listtable">
	          				<tr>
	            				<td height="16" align="left" class="listtable_top" colspan="3"><b>Серверы этой группы</b></td>
	          				</tr>
	          				<tr align="left">
	            				<td width="20%" height="16" class="listtable_1">Имена серверов</td>
